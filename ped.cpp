...
#include "ped.hpp"
using namespace std;
unsigned int Ped::m_vertexbuffer[3];
unsigned int Ped::m_texture;
int Ped::size;
/*
...
Ped::Ped()
{
    ...
    CBitmap image("ped.bmp");               //read bitmap image
...
/*
 Draw Ped
 */
void Ped::drawPed(unsigned int m_program)
{
